...
import './_SettingsUpdateButton.scss';
import { TextEditor } from '../..';

const defaultWidget = new WidgetModel(
    AppWidgets.find(
        ({ type }) => type === 'settings-update-button'
    ) as Reptile.Service.Widget
);

const _SettingsUpdateButton = reactive<Reptile.Props.WidgetProps>(
    ({ widget: widgetWithData }) => {
        ...
        return (
            <div
                ...
                className='rt-settings-update-button'
            >
...
export default _SettingsUpdateButton;
