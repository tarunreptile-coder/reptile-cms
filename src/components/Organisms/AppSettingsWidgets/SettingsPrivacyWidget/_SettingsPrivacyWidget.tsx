...
import './_SettingsPrivacyWidget.scss';
import { TextEditor } from '../..';

const defaultWidget = new WidgetModel(
    AppWidgets.find(
        ({ type }) => type === 'settings-privacy'
    ) as Reptile.Service.Widget
);

const _SettingsPrivacyWidget = reactive<Reptile.Props.WidgetProps>(
...
export default _SettingsPrivacyWidget;
