...
import './_SectionCarouselWidget.scss';
import { UTILS } from '~/Utils';

const defaultWidget = new WidgetModel(
    AppWidgets.find(
        ({ type }) => type === 'app-section-carousel'
    ) as Reptile.Service.Widget
);

const _SectionCarouselWidget = reactive<Reptile.Props.WidgetProps>(
    ({ widget: widgetWithData }) => {
        ...
        return (
            <Flipped flipId={widgetWithData?.id ?? 'preview'}>
                <div
                    className='rt-section-carousel-widget'
                    style={{
...
export default _SectionCarouselWidget;
