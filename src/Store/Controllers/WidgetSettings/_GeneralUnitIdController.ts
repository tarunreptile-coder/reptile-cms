...
export default class GeneralUnitIdController implements IInputPropertyController {
    ...
    constructor(
        ...
        makeAutoObservable<GeneralUnitIdController, '_domain' | '_uiState' | '_generalProperties'>(this, {
            _domain: false,
            _uiState: false,
    ...
    get value(): string {
        return this._generalProperties.unitId as string;
    }

    set value(v: string) {
        this._generalProperties.unitId = v;
    }
