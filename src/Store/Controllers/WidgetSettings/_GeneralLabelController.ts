...
export default class GeneralLabelController implements IInputPropertyController {
    ...
    constructor(
        ...
        makeAutoObservable<GeneralLabelController, '_domain' | '_uiState' | '_generalProperties'>(this, {
            _domain: false,
            _uiState: false,
    ...
    get value(): string {
        return this._generalProperties.label as string;
    }

    set value(v: string) {
        this._generalProperties.label = v;
    }
