...
export default class StyleShadowSpreadController extends StyleBoxShadowBase implements ISliderPropertyController {
    ...
    constructor(
        ...
        makeObservable<StyleShadowSpreadController>(this, {
            value: computed,
            initialize: action,
            deps: computed,
        });
    ...
    get label(): string {
        return 'Box shadow: Spread radius';
    }
