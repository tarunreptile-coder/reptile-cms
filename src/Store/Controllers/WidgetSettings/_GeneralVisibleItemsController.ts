...
export default class GeneralVisibleItemsController
    implements IInputPropertyController
{
    ...
    get value(): string {
        return this._generalProperties.visibleItems?.toString() as string;
    }
    ...
    set value(v: string) {
        ...
        if (nv >= 0) {
            this._generalProperties.visibleItems = nv;
        }
    }
