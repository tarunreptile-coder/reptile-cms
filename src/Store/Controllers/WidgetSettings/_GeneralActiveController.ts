...
export default class GeneralActiveController implements ICheckboxPropertyController {
    ...
    constructor(
        ...
        makeAutoObservable<GeneralActiveController, '_domain' | '_uiState' | '_generalProperties'>(this, {
            _domain: false,
            _uiState: false,
    ...
    get active(): boolean {
        return this._generalProperties.isActive as boolean;
    }

    set active(v: boolean) {
        this._generalProperties.isActive = v;
    }
