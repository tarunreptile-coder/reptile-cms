...
export default class StyleShadowBlurController extends StyleBoxShadowBase implements ISliderPropertyController {
    ...
    constructor(
        ...
        makeObservable<StyleShadowBlurController>(this, {
            value: computed,
            initialize: action,
            deps: computed,
        });
