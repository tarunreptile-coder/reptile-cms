...
type IThemesWidthController = Reptile.Controllers.IThemesWidthController;

export default class ThemesWidthController
    implements IThemesWidthController
{
