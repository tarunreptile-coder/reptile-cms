...
type IThemesFontColorController =
    Reptile.Controllers.IThemesFontColorController;

export default class ThemesFontColorController
    implements IThemesFontColorController
{
