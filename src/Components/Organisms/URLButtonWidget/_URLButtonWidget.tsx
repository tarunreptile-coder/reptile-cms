...
import "./_URLButtonWidget.scss";

const defaultWidget = new WidgetModel(
  AppWidgets.find(({ type }) => type === "url-button") as Reptile.Service.Widget
);

const URLButtonWidget = reactive<Reptile.Props.WidgetProps>(
...
export default URLButtonWidget;
