...
import './_LargeImageListWidget.scss';
import { UTILS } from '~/Utils';

const defaultWidget = new WidgetModel(
    AppWidgets.find(
        ({ type }) => type === 'app-article-collection'
    ) as Reptile.Service.Widget
);

const _LargeImageListWidget = reactive<Reptile.Props.WidgetProps>(
    ({ widget: widgetWithData }) => {
        ...
        return (
            <Flipped flipId={widgetWithData?.id ?? 'preview'}>
                <div
                    className='rt-large-image-list-widget'
                    style={{
                                    ...
                                    <div
                                        ...
                                        style={{
                                            ...
                                            fontWeight:
                                                widget.contents[4].styles
                                                    .fontWeight,
                                            textAlign: widget.contents[4].styles
                                                .textAlign as 'left',
                                        }}
                                    >
                                        {!controller.loading && !!item ? (
...
export default _LargeImageListWidget;
