...
import './_HelpTitleWidget.scss';
import { TextEditor } from '../..';

const defaultWidget = new WidgetModel(
    AppWidgets.find(
        ({ type }) => type === 'help-title'
    ) as Reptile.Service.Widget
);

const _HelpTitleWidget = reactive<Reptile.Props.WidgetProps>(
...
export default _HelpTitleWidget;
